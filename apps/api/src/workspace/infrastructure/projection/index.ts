...
export const ProjectionHandlers = [WorkspaceWasCreatedProjection, WorkspaceNameWasUpdatedProjection, WorkspaceDescriptionWasUpdatedProjection, WorkspaceLocationWasUpdatedProjection];
