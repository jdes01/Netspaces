...
export class SpaceAmenity extends ValueObject<{ value: SpaceAmenitysTypes }> {
	...
	public static fromStringList(amenitys: Array<string>): Result<Array<SpaceAmenity>, SpaceAmenityNotValidError> {
		try {
			return new Ok(
				amenitys.map(
					(amenity) =>
	...
	public static toStringList(amenitys: Array<SpaceAmenity | SpaceAmenitysTypes>): Array<string> {
