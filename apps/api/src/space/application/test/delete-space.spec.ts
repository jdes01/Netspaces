...
import { SpaceAmenity, SpaceId, SpaceName, SpaceQuantity, SpaceSeats } from '../../domain/model/value-objects';
import { Space } from '../../domain/model';
import { WorkspaceId, WorkspaceName } from '../../../workspace/domain/model/value-objects';
...
describe('DeleteSpaceHandler', () => {
    ...
    beforeEach(() => {
        ...
        workspaceId = WorkspaceId.fromString('27afa1a9-863f-43df-9bdd-5ce93bb20ff9')
