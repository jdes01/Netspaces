...
export class UserService {
	...
	async createUser(id: string, name: string): Promise<Result<null, UserError>> {
		return this.commandBus.execute<ICommand, Result<null, UserError>>(new CreateUserCommand(id, name));
	}
