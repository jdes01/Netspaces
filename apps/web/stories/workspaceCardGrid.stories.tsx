...
export const WorkspaceCardComponent = () => <WorkspaceGrid workspaces={[workspaceDTO, workspaceDTOWithCoffee, workspaceDTO, workspaceDTO, workspaceDTOWithCoffee, workspaceDTO, workspaceDTOWithCoffee, workspaceDTO, workspaceDTO, workspaceDTO]} />