...
const CREATE_BOOKING_MUTATION = gql`
  mutation CreateBooking($userId: String!, $spaceId: String!, $date: String!) {
    createBooking(
      bookingInput: { userId: $userId, spaceId: $spaceId, date: $date }
    )
  }
`;
...
export function SpaceCard({ space }: SpaceCardProps) {
  ...
  const bookedDates = serializedBookedDates.length
    ? serializedBookedDates.map((serializedBookedDate) => {
